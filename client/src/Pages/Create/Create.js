          ...
          <div class="flex flex-wrap -m-4 text-center justify-center">
            ...
            {/* <IconContext.Provider value={{ color: 'blue', size: '50px' }}> */}
              <div class="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 flex flex-col items-center">
                ...
                <h2 class="title-font font-medium text-3xl text-gray-900">Add-Posts</h2>
            ...
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div class="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 ">
                ...
                <BiMoviePlay/>
                <h2 class="title-font font-medium text-3xl text-gray-900">Reels</h2>
            ...
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div class="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                ...
                <MdOutlineLiveTv/>
                <h2 class="title-font font-medium text-3xl text-gray-900">Go TV-Live</h2>
